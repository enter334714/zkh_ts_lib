...
enum PBRMetallicSmoothnessSource {
	...
	class RenderState implements IClone  {
		...
		/**stencil测试函数枚举_从不通过。*/
		static STENCIL_NEVER: number;
		/**stencil测试函数枚举_小于时通过。*/
		static STENCIL_LESS: number;
		/**stencil测试函数枚举_等于时通过。*/
		static STENCIL_EQUAL: number;
		/**stencil测试函数枚举_小于等于时通过。*/
		static STENCIL_LEQUAL: number;
		/**stencil测试函数枚举_大于时通过。*/
		static STENCIL_GREATER: number;
		/**stencil测试函数枚举_不等于时通过。*/
		static STENCIL_NOTEQUAL: number;
		/**stencil测试函数枚举_大于等于时通过。*/
		static STENCIL_GEQUAL: number;
		/**stencil测试函数枚举_总是通过。*/
		static STENCIL_ALWAYS: number;

		/**stencil测试操作行为 */
		static STENCIL_ZERO: number;
		/**stencil测试操作值行为 */
		static STENCIL_INVERT: number;
		/**stencil测试操作行为 */
		static STENCIL_KEEP: number;
		/**stencil测试操作行为 */
		static STENCIL_REPLACE: number;
		/**stencil测试操作行为 */
		static STENCIL_INCR: number;
		/**stencil测试操作行为 */
		static STENCIL_DECR: number;
		/**stencil测试操作行为 */
		static STENCIL_INCR_WRAP: number;
		/**stencil测试操作行为 */
		static STENCIL_DECR_WRAP: number;
